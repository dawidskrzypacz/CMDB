...
namespace CMDB.Migrations.NetworkDevicesDb
{
    /// <inheritdoc />
    public partial class NetworkDevicesDbContextCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NetworkDevices", x => x.DeviceID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NetworkDevicesDeviceID = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accessories_NetworkDevices_NetworkDevicesDeviceID",
                        column: x => x.NetworkDevicesDeviceID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accessories_NetworkDevicesDeviceID",
                table: "Accessories",
                column: "NetworkDevicesDeviceID");
