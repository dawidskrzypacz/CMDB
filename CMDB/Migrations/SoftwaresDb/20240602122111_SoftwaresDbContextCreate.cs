...
namespace CMDB.Migrations.SoftwaresDb
{
    /// <inheritdoc />
    public partial class SoftwaresDbContextCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EmployeesEmployeeID = table.Column<int>(type: "int", nullable: true),
                    SoftwaresSoftwareID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "EmployeeID");
                    table.ForeignKey(
                        name: "FK_Computers_Softwares_SoftwaresSoftwareID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Computers_SoftwaresSoftwareID",
                table: "Computers",
